...
function Home() {
  ...
  const index = `[![Continuous Integration](https://github.com/pierrenodet/spark-ensemble/actions/workflows/ci.yml/badge.svg)](https://github.com/pierrenodet/spark-ensemble/actions/workflows/ci.yml) [![codecov](https://codecov.io/gh/pierrenodet/spark-ensemble/branch/main/graph/badge.svg)](https://codecov.io/gh/pierrenodet/spark-ensemble) [![Gitter](https://badges.gitter.im/spark-ensemble/community.svg)](https://gitter.im/spark-ensemble/community?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge) [![License](https://img.shields.io/badge/license-Apache--2.0-blue.svg)](https://github.com/pierrenodet/spark-ensemble/blob/main/LICENSE) [![Maven Central](https://img.shields.io/maven-central/v/com.github.pierrenodet/spark-ensemble_2.12.svg?label=maven-central&colorB=blue)](https://search.maven.org/search?q=g:%22com.github.pierrenodet%22%20AND%20a:%22spark-ensemble_2.12%22)
  `.trim();
  return (
    <Layout
      title="Home"
